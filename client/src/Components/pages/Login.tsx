...
const Login = () => {
  ...
  const module_address =
    "0xe04053115104aa71b7f70cd48cd47a19a246dbb09220aa1c7299ec04d526133e";
  ...
  return (
    <div className="page">
      {account?.address ? (
        <Link to="/">
          <div className="login-note">Click here to move to Home-page</div>
        </Link>
      ) : (
      ...
      {accountHasUser ? (
        ...
        <button onClick={createUser} className="create-button">
          Create User
        </button>
      )}
      {accountHasResource ? (
        ...
        <button onClick={createResource} className="create-button">
          Create Resource
        </button>
      )}
    </div>
